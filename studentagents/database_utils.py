...
def map_student_data_to_context(student_data):
    ...
    try:
        print(f"DEBUG: student_data keys: {list(student_data.keys()) if student_data else 'None'}")
        
        if not student_data:
            print("WARNING: student_data is None or empty, using defaults")
        ...
        print(f"ERROR in map_student_data_to_context: {e}")
